...
11. Baseline reproduction confirmed
	+ HAAQI matches published baseline exactly for both variants.
	+ CTW and overall are marginally above target within acceptable tolerance. 
