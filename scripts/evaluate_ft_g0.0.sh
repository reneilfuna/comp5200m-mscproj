#!/bin/bash
#SBATCH --job-name=demucs_ft_eval_g0.0
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_eval_g0.0_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_eval_g0.0_%j.err
...
echo "Fine-tuned evaluate complete: gamma=0.0"
