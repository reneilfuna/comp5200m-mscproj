#!/bin/bash
#SBATCH --job-name=demucs_eval_b0.5
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_eval_b0.5_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_eval_b0.5_%j.err
...
echo "DEMUCS evaluate complete: gamma=0.0 beta=0.5"
