...
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_eval_b0.5_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_eval_b0.5_%j.err
...
echo "Fine-tuned evaluate complete: gamma=0.2, beta=0.5"
