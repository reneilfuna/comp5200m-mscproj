#!/bin/bash
#SBATCH --job-name=demucs_ft_b0.25
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_b0.25_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_b0.25_%j.err
...
echo "Fine-tuned enhance complete: beta=0.25"
echo "Output: $EXP_DIR"
