#!/bin/bash
#SBATCH --job-name=demucs_enhance_g0.0
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_enhance_g0.0_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_enhance_g0.0_%j.err
