#!/bin/bash
#SBATCH --job-name=cad2_enh_test
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/enhance_test_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/enhance_test_%j.err
...
echo "Stage 2 enhance test complete"
