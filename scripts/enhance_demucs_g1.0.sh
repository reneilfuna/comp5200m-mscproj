#!/bin/bash
#SBATCH --job-name=demucs_enhance_g1.0
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_enhance_g1.0_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_enhance_g1.0_%j.err
...
echo "DEMUCS enhance complete: gamma=1.0 beta=0.5"
echo "Output: $EXP_DIR"
