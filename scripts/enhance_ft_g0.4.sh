#!/bin/bash
#SBATCH --job-name=demucs_ft_g0.4
#SBATCH --output=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_g0.4_%j.out
#SBATCH --error=/mnt/scratch/sc21rf/cadenza/logs/demucs_ft_g0.4_%j.err
...
echo "Fine-tuned enhance complete: gamma=0.4"
echo "Output: $EXP_DIR"
